...
class BugReporterApp:
    ...
    def create_report_form(self, parent):
        ...
        self.title_entry.grid(row=row, column=1, columnspan=5, sticky=tk.W, pady=2) 
        row += 1
        ...
        self.desc_text.grid(row=row, column=1, columnspan=5, sticky=tk.W, pady=2) 
        row += 1
        ...
        self.steps_text.grid(row=row, column=1, columnspan=5, sticky=tk.W, pady=2)
        row += 1
